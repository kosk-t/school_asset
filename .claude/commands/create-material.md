...
#### A. 歴史ストーリー（実際にあった話）⭐最優先
「本当にあった話」は説得力があり、数学が実際に役立った証拠になる。
...
| 円周率 | アルキメデスの近似法 | 正96角形を使って円周率を3.14...と計算した |
| 統計 | ナイチンゲールの統計グラフ | クリミア戦争で「病院の衛生状態が悪い」ことをグラフで証明、医療改革を実現 |

#### B. 学びのあるストーリー（他分野への応用）⭐おすすめ
数学を学びながら、科学・経済・芸術など他分野の知識も得られる題材。
...
| テーマ | 題材 | 学べること |
|--------|------|-----------|
| 指数関数 | 複利の力と借金の怖さ | 「72の法則」、リボ払いの罠 |
| 一次関数 | 損益分岐点 | 何個売れば黒字になるか |
| 割合・比 | 税金の仕組み | 消費税、所得税の累進課税 |
| 統計 | 平均年収のウソ | 平均値と中央値の違い |
...
#### C. フィクションストーリー（架空の話）
A・Bに適した題材がない場合の最終手段。できるだけA・Bを優先すること。
